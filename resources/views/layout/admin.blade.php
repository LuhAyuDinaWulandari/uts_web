...
<html>
  <head> 
    ...
    <title>{{(isset($title)?$title:'Counter')}}</title>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <a id="logout" href="login.html" class="nav-link"> <span class="d-none d-sm-inline">Login </span><i class="icon-logout"></i></a></div>
          </div>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          ...
          <div class="title">
            <h1 class="h5">Luh Ayu Dina Wulandari</h1>
            <p>PTI</p>
          </div>
        </div>
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Daftar Pembeli</a>
          ...
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Jenis Operator </a>
            <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
              <li><a href="#">Telkomsel Simpati</a></li>
              <li><a href="#">Indosat</a></li>
              <li><a href="#">XL Axiata</a></li>
              <li><a href="#">SmartFreen</a></li>
            </ul>
          </li>
        ...
        <footer class="footer">
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              ...
              <p class="no-margin-bottom">2020 &copy; Counter Pulsa Bersama. Design by <a href="devisantini29@gmail.com">Luh Ayu Dina Wulandari</a>.</p>
            </div>
          </div>
        </footer>
      </div>
